            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="float-right">
                   <router-link to="/addSubCategory" class="btn btn-sm btn-outline-success"><i class="fa fa-plus"></i> Add New</router-link>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="(categoryList, index) in getCategoryList" :key="categoryList.id">
                      ...
                      <td>
                        <div>
                         <router-link :to="`/editSubCategory/${categoryList.id}`"> <i class="fa fa-edit text-info"></i> </router-link>
